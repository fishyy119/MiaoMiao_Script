...
def concat_images(image1_path, image2_path, output_path):
...
# 获取当前目录下的所有图片文件
image_files = [os.path.join(current_dir, file) for file in os.listdir(current_dir) if file.split('.')[-1].lower() in {'png', 'jpg', 'jpeg', 'bmp', 'gif', 'tiff'}]
